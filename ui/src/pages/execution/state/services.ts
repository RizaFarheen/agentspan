...
export const restartExecution = async (
  ...
  const url = `/api/agent/executions/${executionId}/restart${toMaybeQueryString(options)}`;
...
export const retryExecution = async (
  ...
  const url = `/api/agent/executions/${executionId}/retry${toMaybeQueryString(
    retryOptions,
  )}`;
...
export const terminateExecution = async ({
  ...
  const url = `/api/agent/executions/${executionId}${maybeTriggerFailureWorkflow()}`;
  try {
    const result = await fetchWithContext(
      url,
      {},
...
export const resumeExecution = async ({
  ...
  const url = `/api/agent/${executionId}/resume`;
  try {
    const result = await fetchWithContext(
      url,
      {},
...
export const pauseExecution = async ({
  ...
  const url = `/api/agent/${executionId}/pause`;
  try {
    const result = await fetchWithContext(
      url,
      {},
...
export const updateVariables = async (
  ...
  const url = `/api/agent/executions/${executionId}/variables`;
